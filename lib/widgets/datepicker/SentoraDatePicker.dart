...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    pickerModel,
        ...
        this.theme = theme ?? SentoraDatePickerTheme(),
        super(settings: settings);

  final bool showTitleActions;
  final DateChangedCallback onChanged;
  final DateChangedCallback onConfirm;
  final SentoraDatePickerTheme theme;
...
class _DatePickerState extends State<_DatePickerComponent> {
  ...
  Widget build(BuildContext context) {
    SentoraDatePickerTheme theme = widget.route.theme;
  ...
  Widget _renderPickerView(SentoraDatePickerTheme theme) {
  ...
  Widget _renderItemView(SentoraDatePickerTheme theme) {
    return Container(
  ...
  // Title View
  Widget _renderTitleActionsView(SentoraDatePickerTheme theme) {
            ...
            child: CupertinoButton(
              ...
              onPressed: () {
                ...
                if (widget.route.onConfirm != null) {
                  retVal = widget.route.onConfirm(widget.pickerModel.finalTime());
                }
